...
<template>
  <div class="inner_wrapper">
    ...
    <AutoColumns columns="2" ruleColor="#999">
      ...
      <p>And the same goes for many other of these 'game engines' I've come to know. Most of them never became <u>real</u> games, I usually get bored way before it becomes even playable, but you might still find it fun to click through a few of the examples I made. You can find the source code on <a href="https://www.github.com/rvounik" target="_blank">My Github</a>.</p>
